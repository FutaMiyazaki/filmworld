...
export const useRevenueMovies = () => {
  ...
  const { data: revenueMovies, error } = useSWR(
    router.query.page
      ? router.query.year
        ? `https://api.themoviedb.org/3/discover/movie?api_key=a9f5f6a6a7d86b9c7a665290b1dc19ca&language=ja-JP&include_adult=false&page=${router.query.page}&year=${router.query.year}&sort_by=revenue.desc`
